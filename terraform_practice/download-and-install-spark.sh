#!/bin/bash
# This is a script from Cheuk Lau to download and install spark and hadoop from a public S3 Bucket
# See https://github.com/cheuklau/insight_zone_defense/blob/master/devops/multi_with_asg/packer/scripts/download-and-install-spark.sh
