...
default['kafka-cluster']['service']['binary_url'] = "http://mirror.cc.columbia.edu/pub/software/apache/kafka/%{version}/kafka_%{scala_version}-%{version}.tgz" # rubocop:disable Style/StringLiterals