    ...
    class KafkaService < Chef::Provider
      ...
      def action_enable
        notifying_block do
          ...
          # libartifact has been deprecated. The checksums aren't current, so this just breaks installation
          ...
          # Use poise_archive instead of libartifact to download and install.
